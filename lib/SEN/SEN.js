...
export class SEN {
    ...
    SENSOR_TYPE() {
        ...
        return offset ? this.bb.readInt8(this.bb_pos + offset) : SensorType.UNKNOWN;
    }
    ...
    static createSEN(builder, LATITUDE, LONGITUDE, ALTITUDE, CREATED_ATOffset, CREATED_BYOffset, DATA_MODE, ID_SENSOROffset, SIT_IDOffset, SENSOR_TYPE, SOURCEOffset, DATA_IDOffset, CLASSIFICATIONOffset, UPDATED_ATOffset, UPDATED_BYOffset, LAST_OB_TIMEOffset, LOWER_LEFT_ELEVATION_LIMIT, UPPER_LEFT_AZIMUTH_LIMIT, LOWER_RIGHT_ELEVATION_LIMIT, LOWER_LEFT_AZIMUTH_LIMIT, UPPER_RIGHT_ELEVATION_LIMIT, UPPER_RIGHT_AZIMUTH_LIMIT, LOWER_RIGHT_AZIMUTH_LIMIT, UPPER_LEFT_ELEVATION_LIMIT, RIGHT_GEO_BELT_LIMIT, LEFT_GEO_BELT_LIMIT, BANDOffset, MAGNITUDE_LIMIT, TASKABLE) {
        ...
        SEN.addSitId(builder, SIT_IDOffset);
        SEN.addSensorType(builder, SENSOR_TYPE);
...
export class SENT {
    ...
    pack(builder) {
        ...
        return SEN.createSEN(builder, this.LATITUDE, this.LONGITUDE, this.ALTITUDE, CREATED_AT, CREATED_BY, this.DATA_MODE, ID_SENSOR, SIT_ID, this.SENSOR_TYPE, SOURCE, DATA_ID, CLASSIFICATION, UPDATED_AT, UPDATED_BY, LAST_OB_TIME, this.LOWER_LEFT_ELEVATION_LIMIT, this.UPPER_LEFT_AZIMUTH_LIMIT, this.LOWER_RIGHT_ELEVATION_LIMIT, this.LOWER_LEFT_AZIMUTH_LIMIT, this.UPPER_RIGHT_ELEVATION_LIMIT, this.UPPER_RIGHT_AZIMUTH_LIMIT, this.LOWER_RIGHT_AZIMUTH_LIMIT, this.UPPER_LEFT_ELEVATION_LIMIT, this.RIGHT_GEO_BELT_LIMIT, this.LEFT_GEO_BELT_LIMIT, BAND, this.MAGNITUDE_LIMIT, this.TASKABLE);
    }
}
