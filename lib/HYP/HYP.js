...
export class HYP {
    ...
    static createHYP(builder, OBJECT_IDSOffset, NAMEOffset, CATEGORYOffset, ROW_INDICATORSOffset, COL_INDICATORSOffset, MATRIXOffset, SCOREOffset, ANALYSIS_METHODOffset, EVENT_START_TIMEOffset, EVENT_END_TIMEOffset) {
    ...
    unpack() {
        return new HYPT(this.bb.createScalarList(this.OBJECT_IDS.bind(this), this.objectIdsLength()), this.NAME(), this.CATEGORY(), this.bb.createScalarList(this.ROW_INDICATORS.bind(this), this.rowIndicatorsLength()), this.bb.createScalarList(this.COL_INDICATORS.bind(this), this.colIndicatorsLength()), this.bb.createScalarList(this.MATRIX.bind(this), this.matrixLength()), this.bb.createObjList(this.SCORE.bind(this), this.scoreLength()), this.ANALYSIS_METHOD(), this.EVENT_START_TIME(), this.EVENT_END_TIME());
    }
    unpackTo(_o) {
...
export class HYPT {
    constructor(OBJECT_IDS = [], NAME = null, CATEGORY = null, ROW_INDICATORS = [], COL_INDICATORS = [], MATRIX = [], SCORE = [], ANALYSIS_METHOD = null, EVENT_START_TIME = null, EVENT_END_TIME = null) {
    ...
    pack(builder) {
        ...
        return HYP.createHYP(builder, OBJECT_IDS, NAME, CATEGORY, ROW_INDICATORS, COL_INDICATORS, MATRIX, SCORE, ANALYSIS_METHOD, EVENT_START_TIME, EVENT_END_TIME);
    }
}
